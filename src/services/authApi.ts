...
export const mapIdentityProfileToUser = (profile: IdentityUserProfileResponse): User => {
  ...
  return {
    ...
    bvnVerified: !!profile.bvnLast4 && (profile.kycTier === 'verified' || profile.kycTier === 'premium' || profile.kycDocumentStatus === 'verified'),
    ninVerified: !!profile.ninLast4 && (profile.kycTier === 'premium' || (profile.kycTier === 'verified' && profile.kycDocumentStatus === 'verified')),
